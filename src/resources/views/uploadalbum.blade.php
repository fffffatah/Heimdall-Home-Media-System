...
<form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="card" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupFile01">Songs</label>
                            <input type="file" value="{{old('songs')}}" name="songs[]" class="form-control" id="inputGroupFile01" multiple>
                        </div>
                        <span style="color:red;">{{$errors->first('songs')}}</span>
                    </li>
                    <li class="list-group-item">
                        <input class="form-control me-2" value="{{old('title')}}" name="title" type="text" placeholder="Album Title" aria-label="Album Title">
                        <span style="color:red;">{{$errors->first('title')}}</span>
                    </li>
                    <li class="list-group-item">
                        <input class="form-control me-2" value="{{old('artist')}}" name="artist" type="text" placeholder="Artist" aria-label="Artist">
                        <span style="color:red;">{{$errors->first('title')}}</span>
                    </li>
                    <li class="list-group-item">
